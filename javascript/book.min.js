...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(n){l.reject(n)}};f.prototype.then=function(h,k){function l(B,v){return"function"==typeof B?function(u){try{n(B(u))}catch(w){p(w)}}:v}var n,p,q=new f(function(B,v){n=B;p=v});this.callWhenSettled_(l(h,n),l(k,p));return q};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(n.state_){case 1:h(n.result_);
...
p){function q(u){return function(w){B[u]=w;v--;0==v&&n(B)}}var B=[],v=0;do B.push(void 0),v++,d(l.value).callWhenSettled_(q(B.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
(function(b,c,d,e){function f(m,r,t){return setTimeout(n(m,t),r)}function g(m,r,t){return Array.isArray(m)?(h(m,t[r],t),!0):!1}function h(m,r,t){var z;if(m)if(m.forEach)m.forEach(r,t);else if(m.length!==e)for(z=0;z<m.length;)r.call(t,m[z],z,m),z++;else for(z in m)m.hasOwnProperty(z)&&r.call(t,m[z],z,m)}function k(m,r,t){var z="DEPRECATED METHOD: "+r+"\n"+t+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var D=b.console&&(b.console.warn||b.console.log);D&&D.call(b.console,z,C);return m.apply(this,arguments)}}function l(m,r,t){r=r.prototype;var z=m.prototype=Object.create(r);z.constructor=m;z._super=r;t&&S(z,t)}function n(m,r){return function(){return m.apply(r,arguments)}}function p(m,r){return"function"==typeof m?m.apply(r?r[0]||e:e,r):m}function q(m,r,t){h(u(r),function(z){"undefined"!=typeof b.addEventListener?m.addEventListener(z,t,!1):m.attachEvent(z,t)})}
function B(m,r,t){h(u(r),function(z){"undefined"!=typeof b.removeEventListener?m.removeEventListener(z,t,!1):m.detachEvent(z,t,!1)})}function v(m,r){for(;m;){if(m==r)return!0;m=m.parentNode}return!1}function u(m){return m.trim().split(/\s+/g)}function w(m,r,t){if(m.indexOf&&!t)return m.indexOf(r);for(var z=0;z<m.length;){if(t&&m[z][t]==r||!t&&m[z]===r)return z;z++}return-1}function x(m){return Array.prototype.slice.call(m,0)}function y(m,r,t){for(var z=[],C=[],D=0;D<m.length;){var E=r?m[D][r]:m[D];
0>w(C,E)&&z.push(m[D]);C[D]=E;D++}t&&(z=r?z.sort(function(J,P){return J[r]>P[r]}):z.sort());return z}function A(m,r){if(r&&r[0]){for(var t,z=r[0].toUpperCase()+r.slice(1),C=0;C<oa.length;){t=(t=oa[C])?t+z:r;if(t in m)return t;C++}return e}}function G(m){m=m.ownerDocument||m;return m.defaultView||m.parentWindow||b}function F(m,r){var t=this;this.manager=m;this.callback=r;this.element=m.element;this.target=m.options.inputTarget;this.domHandler=function(z){p(m.options.enable,[m])&&t.handler(z)};this.init()}
function O(m,r,t){var z=t.pointers.length,C=t.changedPointers.length;var D=r&1&&0===z-C;t.isFirst=!!D;t.isFinal=!!(r&12&&0===z-C);D&&(m.session={});t.eventType=r;r=m.session;z=t.pointers;C=z.length;r.firstInput||(r.firstInput=L(t));1<C&&!r.firstMultiple?r.firstMultiple=L(t):1===C&&(r.firstMultiple=!1);D=r.firstInput;var E=(C=r.firstMultiple)?C.center:D.center;var J=t.center=H(z);t.timeStamp=fa();t.deltaTime=t.timeStamp-D.timeStamp;t.angle=M(E,J);t.distance=K(E,J);D=t.center;E=r.offsetDelta||{};J=
r.prevDelta||{};var P=r.prevInput||{};if(1===t.eventType||4===P.eventType)J=r.prevDelta={x:P.deltaX||0,y:P.deltaY||0},E=r.offsetDelta={x:D.x,y:D.y};t.deltaX=J.x+(D.x-E.x);t.deltaY=J.y+(D.y-E.y);t.offsetDirection=I(t.deltaX,t.deltaY);E=t.deltaTime;D=t.deltaX/E||0;E=t.deltaY/E||0;t.overallVelocityX=D;t.overallVelocityY=E;t.overallVelocity=V(D)>V(E)?D:E;C?(D=C.pointers,D=K(z[0],z[1],Y)/K(D[0],D[1],Y)):D=1;t.scale=D;C?(C=C.pointers,z=M(z[1],z[0],Y)+M(C[1],C[0],Y)):z=0;t.rotation=z;t.maxPointers=r.prevInput?
t.pointers.length>r.prevInput.maxPointers?t.pointers.length:r.prevInput.maxPointers:t.pointers.length;E=r.lastInterval||t;z=t.timeStamp-E.timeStamp;8!=t.eventType&&(25<z||E.velocity===e)?(D=t.deltaX-E.deltaX,E=t.deltaY-E.deltaY,J=D/z||0,P=E/z||0,z=J,C=P,J=V(J)>V(P)?J:P,D=I(D,E),r.lastInterval=t):(J=E.velocity,z=E.velocityX,C=E.velocityY,D=E.direction);t.velocity=J;t.velocityX=z;t.velocityY=C;t.direction=D;r=m.element;v(t.srcEvent.target,r)&&(r=t.srcEvent.target);t.target=r;m.emit("hammer.input",t);
m.recognize(t);m.session.prevInput=t}function L(m){for(var r=[],t=0;t<m.pointers.length;)r[t]={clientX:X(m.pointers[t].clientX),clientY:X(m.pointers[t].clientY)},t++;return{timeStamp:fa(),pointers:r,center:H(r),deltaX:m.deltaX,deltaY:m.deltaY}}function H(m){var r=m.length;if(1===r)return{x:X(m[0].clientX),y:X(m[0].clientY)};for(var t=0,z=0,C=0;C<r;)t+=m[C].clientX,z+=m[C].clientY,C++;return{x:X(t/r),y:X(z/r)}}function I(m,r){return m===r?1:V(m)>=V(r)?0>m?2:4:0>r?8:16}function K(m,r,t){t||(t=pa);var z=
r[t[0]]-m[t[0]];m=r[t[1]]-m[t[1]];return Math.sqrt(z*z+m*m)}function M(m,r,t){t||(t=pa);return 180*Math.atan2(r[t[1]]-m[t[1]],r[t[0]]-m[t[0]])/Math.PI}function W(){this.evEl=za;this.evWin=Aa;this.pressed=!1;F.apply(this,arguments)}function Z(){this.evEl=qa;this.evWin=ra;F.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function aa(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;F.apply(this,arguments)}function T(){this.evTarget=
Ba;this.targetIds={};F.apply(this,arguments)}function U(m,r){var t=x(m.touches),z=this.targetIds;if(r&3&&1===t.length)return z[t[0].identifier]=!0,[t,t];m=x(m.changedTouches);var C=[],D=this.target;var E=t.filter(function(J){return v(J.target,D)});if(1===r)for(t=0;t<E.length;)z[E[t].identifier]=!0,t++;for(t=0;t<m.length;)z[m[t].identifier]&&C.push(m[t]),r&12&&delete z[m[t].identifier],t++;if(C.length)return[y(E.concat(C),"identifier",!0),C]}function ha(){F.apply(this,arguments);var m=n(this.handler,
this);this.touch=new T(this.manager,m);this.mouse=new W(this.manager,m);this.primaryTouch=null;this.lastTouches=[]}function sa(m){m=m.changedPointers[0];if(m.identifier===this.primaryTouch){var r={x:m.clientX,y:m.clientY};this.lastTouches.push(r);var t=this.lastTouches;setTimeout(function(){var z=t.indexOf(r);-1<z&&t.splice(z,1)},2500)}}function ia(m,r){this.manager=m;this.set(r)}function Ca(m){if(-1<m.indexOf("none"))return"none";var r=-1<m.indexOf("pan-x"),t=-1<m.indexOf("pan-y");return r&&t?"none":
r||t?r?"pan-x":"pan-y":-1<m.indexOf("manipulation")?"manipulation":"auto"}function Q(m){this.options=S({},this.defaults,m||{});this.id=Da++;this.manager=null;m=this.options.enable;this.options.enable=m===e?!0:m;this.state=1;this.simultaneous={};this.requireFail=[]}function ta(m){return m&16?"cancel":m&8?"end":m&4?"move":m&2?"start":""}function ua(m){return 16==m?"down":8==m?"up":2==m?"left":4==m?"right":""}function ba(m,r){return(r=r.manager)?r.get(m):m}function N(){Q.apply(this,arguments)}function ca(){N.apply(this,
arguments);this.pY=this.pX=null}function ja(){N.apply(this,arguments)}function ka(){Q.apply(this,arguments);this._input=this._timer=null}function la(){N.apply(this,arguments)}function ma(){N.apply(this,arguments)}function da(){Q.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function R(m,r){r=r||{};var t=r.recognizers;r.recognizers=t===e?R.defaults.preset:t;return new na(m,r)}function na(m,r){this.options=S({},R.defaults,r||{});this.options.inputTarget=
this.options.inputTarget||m;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=m;this.input=new ha(this,O);this.touchAction=new ia(this,this.options.touchAction);va(this,!0);h(this.options.recognizers,function(t){var z=this.add(new t[0](t[1]));t[2]&&z.recognizeWith(t[2]);t[3]&&z.requireFailure(t[3])},this)}function va(m,r){var t=m.element;if(t.style){var z;h(m.options.cssProps,function(C,D){z=A(t.style,D);r?(m.oldCssProps[z]=t.style[z],t.style[z]=C):t.style[z]=m.oldCssProps[z]||
""});r||(m.oldCssProps={})}}function Ea(m,r){var t=c.createEvent("Event");t.initEvent(m,!0,!0);t.gesture=r;r.target.dispatchEvent(t)}var oa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),X=Math.round,V=Math.abs,fa=Date.now;var S="function"!==typeof Object.assign?function(m){if(m===e||null===m)throw new TypeError("Cannot convert undefined or null to object");for(var r=Object(m),t=1;t<arguments.length;t++){var z=arguments[t];if(z!==e&&null!==z)for(var C in z)z.hasOwnProperty(C)&&(r[C]=z[C])}return r}:
Object.assign;var wa=k(function(m,r,t){for(var z=Object.keys(r),C=0;C<z.length;){if(!t||t&&m[z[C]]===e)m[z[C]]=r[z[C]];C++}return m},"extend","Use `assign`."),Ga=k(function(m,r){return wa(m,r,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var pa=["x","y"],Y=["clientX","clientY"];F.prototype={handler:function(){},init:function(){this.evEl&&q(this.element,this.evEl,this.domHandler);this.evTarget&&
q(this.target,this.evTarget,this.domHandler);this.evWin&&q(G(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&B(this.element,this.evEl,this.domHandler);this.evTarget&&B(this.target,this.evTarget,this.domHandler);this.evWin&&B(G(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},za="mousedown",Aa="mousemove mouseup";l(W,F,{handler:function(m){var r=Ja[m.type];r&1&&0===m.button&&(this.pressed=!0);r&2&&1!==m.which&&(r=4);this.pressed&&(r&4&&
(this.pressed=!1),this.callback(this.manager,r,{pointers:[m],changedPointers:[m],pointerType:"mouse",srcEvent:m}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},qa="pointerdown",ra="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(qa="MSPointerDown",ra="MSPointerMove MSPointerUp MSPointerCancel");l(Z,F,{handler:function(m){var r=this.store,t=!1,z=m.type.toLowerCase().replace("ms","");z=Ka[z];var C=
La[m.pointerType]||m.pointerType,D="touch"==C,E=w(r,m.pointerId,"pointerId");z&1&&(0===m.button||D)?0>E&&(r.push(m),E=r.length-1):z&12&&(t=!0);0>E||(r[E]=m,this.callback(this.manager,z,{pointers:r,changedPointers:[m],pointerType:C,srcEvent:m}),t&&r.splice(E,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(aa,F,{handler:function(m){var r=Ma[m.type];1===r&&(this.started=!0);if(this.started){var t=x(m.touches);var z=x(m.changedTouches);r&12&&(t=y(t.concat(z),"identifier",!0));t=[t,
z];r&12&&0===t[0].length-t[1].length&&(this.started=!1);this.callback(this.manager,r,{pointers:t[0],changedPointers:t[1],pointerType:"touch",srcEvent:m})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ba="touchstart touchmove touchend touchcancel";l(T,F,{handler:function(m){var r=Na[m.type],t=U.call(this,m,r);t&&this.callback(this.manager,r,{pointers:t[0],changedPointers:t[1],pointerType:"touch",srcEvent:m})}});l(ha,F,{handler:function(m,r,t){var z="mouse"==t.pointerType;if(!(z&&t.sourceCapabilities&&
t.sourceCapabilities.firesTouchEvents)){if("touch"==t.pointerType)r&1?(this.primaryTouch=t.changedPointers[0].identifier,sa.call(this,t)):r&12&&sa.call(this,t);else{if(z)a:{z=t.srcEvent.clientX;for(var C=t.srcEvent.clientY,D=0;D<this.lastTouches.length;D++){var E=this.lastTouches[D],J=Math.abs(C-E.y);if(25>=Math.abs(z-E.x)&&25>=J){z=!0;break a}}z=!1}if(z)return}this.callback(m,r,t)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var xa=A(Fa.style,"touchAction"),ya=xa!==e,ea=function(){if(!ya)return!1;
var m={},r=b.CSS&&b.CSS.supports;"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(t){m[t]=r?b.CSS.supports("touch-action",t):!0});return m}();ia.prototype={set:function(m){"compute"==m&&(m=this.compute());ya&&this.manager.element.style&&ea[m]&&(this.manager.element.style[xa]=m);this.actions=m.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var m=[];h(this.manager.recognizers,function(r){p(r.options.enable,[r])&&(m=
m.concat(r.getTouchAction()))});return Ca(m.join(" "))},preventDefaults:function(m){var r=m.srcEvent,t=m.offsetDirection;if(this.manager.session.prevented)r.preventDefault();else{var z=this.actions,C=-1<z.indexOf("none")&&!ea.none,D=-1<z.indexOf("pan-y")&&!ea["pan-y"];z=-1<z.indexOf("pan-x")&&!ea["pan-x"];if(C){var E=2>m.distance,J=250>m.deltaTime;if(1===m.pointers.length&&E&&J)return}if(!z||!D)if(C||D&&t&6||z&&t&24)return this.preventSrc(r)}},preventSrc:function(m){this.manager.session.prevented=
...
var r=this.requireFail;m=ba(m,this);-1===w(r,m)&&(r.push(m),m.requireFailure(this));return this},dropRequireFailure:function(m){if(g(m,"dropRequireFailure",this))return this;m=ba(m,this);m=w(this.requireFail,m);-1<m&&this.requireFail.splice(m,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(m){return!!this.simultaneous[m.id]},emit:function(m){function r(C){t.manager.emit(C,m)}var t=this,z=this.state;8>z&&r(t.options.event+ta(z));r(t.options.event);
m.additionalEvent&&r(m.additionalEvent);8<=z&&r(t.options.event+ta(z))},tryEmit:function(m){if(this.canEmit())return this.emit(m);this.state=32},canEmit:function(){for(var m=0;m<this.requireFail.length;){if(!(this.requireFail[m].state&33))return!1;m++}return!0},recognize:function(m){m=S({},m);p(this.options.enable,[this,m])?(this.state&56&&(this.state=1),this.state=this.process(m),this.state&30&&this.tryEmit(m)):(this.reset(),this.state=32)},process:function(m){},getTouchAction:function(){},reset:function(){}};
l(N,Q,{defaults:{pointers:1},attrTest:function(m){var r=this.options.pointers;return 0===r||m.pointers.length===r},process:function(m){var r=this.state,t=m.eventType,z=r&6;m=this.attrTest(m);return z&&(t&8||!m)?r|16:z||m?t&4?r|8:r&2?r|4:2:32}});l(ca,N,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var m=this.options.direction,r=[];m&6&&r.push("pan-y");m&24&&r.push("pan-x");return r},directionTest:function(m){var r=this.options,t=!0,z=m.distance,C=m.direction,
D=m.deltaX,E=m.deltaY;C&r.direction||(r.direction&6?(C=0===D?1:0>D?2:4,t=D!=this.pX,z=Math.abs(m.deltaX)):(C=0===E?1:0>E?8:16,t=E!=this.pY,z=Math.abs(m.deltaY)));m.direction=C;return t&&z>r.threshold&&C&r.direction},attrTest:function(m){return N.prototype.attrTest.call(this,m)&&(this.state&2||!(this.state&2)&&this.directionTest(m))},emit:function(m){this.pX=m.deltaX;this.pY=m.deltaY;var r=ua(m.direction);r&&(m.additionalEvent=this.options.event+r);this._super.emit.call(this,m)}});l(ja,N,{defaults:{event:"pinch",
threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(m){return this._super.attrTest.call(this,m)&&(Math.abs(m.scale-1)>this.options.threshold||this.state&2)},emit:function(m){1!==m.scale&&(m.additionalEvent=this.options.event+(1>m.scale?"in":"out"));this._super.emit.call(this,m)}});l(ka,Q,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(m){var r=this.options,t=m.pointers.length===r.pointers,z=m.distance<
r.threshold,C=m.deltaTime>r.time;this._input=m;if(!z||!t||m.eventType&12&&!C)this.reset();else if(m.eventType&1)this.reset(),this._timer=f(function(){this.state=8;this.tryEmit()},r.time,this);else if(m.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(m){8===this.state&&(m&&m.eventType&4?this.manager.emit(this.options.event+"up",m):(this._input.timeStamp=fa(),this.manager.emit(this.options.event,this._input)))}});l(la,N,{defaults:{event:"rotate",threshold:0,
pointers:2},getTouchAction:function(){return["none"]},attrTest:function(m){return this._super.attrTest.call(this,m)&&(Math.abs(m.rotation)>this.options.threshold||this.state&2)}});l(ma,N,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return ca.prototype.getTouchAction.call(this)},attrTest:function(m){var r=this.options.direction;if(r&30)var t=m.overallVelocity;else r&6?t=m.overallVelocityX:r&24&&(t=m.overallVelocityY);return this._super.attrTest.call(this,
m)&&r&m.offsetDirection&&m.distance>this.options.threshold&&m.maxPointers==this.options.pointers&&V(t)>this.options.velocity&&m.eventType&4},emit:function(m){var r=ua(m.offsetDirection);r&&this.manager.emit(this.options.event+r,m);this.manager.emit(this.options.event,m)}});l(da,Q,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(m){var r=this.options,t=m.pointers.length===r.pointers,z=m.distance<
r.threshold,C=m.deltaTime<r.time;this.reset();if(m.eventType&1&&0===this.count)return this.failTimeout();if(z&&C&&t){if(4!=m.eventType)return this.failTimeout();t=this.pTime?m.timeStamp-this.pTime<r.interval:!0;z=!this.pCenter||K(this.pCenter,m.center)<r.posThreshold;this.pTime=m.timeStamp;this.pCenter=m.center;this.count=z&&t?this.count+1:1;this._input=m;if(0===this.count%r.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},r.interval,this),2):8}return 32},
...
taps:2},["tap"]],[ka]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};na.prototype={set:function(m){S(this.options,m);m.touchAction&&this.touchAction.update();m.inputTarget&&(this.input.destroy(),this.input.target=m.inputTarget,this.input.init());return this},stop:function(m){this.session.stopped=m?2:1},recognize:function(m){var r=this.session;if(!r.stopped){this.touchAction.preventDefaults(m);var t=this.recognizers,
z=r.curRecognizer;if(!z||z&&z.state&8)z=r.curRecognizer=null;for(var C=0;C<t.length;){var D=t[C];2===r.stopped||z&&D!=z&&!D.canRecognizeWith(z)?D.reset():D.recognize(m);!z&&D.state&14&&(z=r.curRecognizer=D);C++}}},get:function(m){if(m instanceof Q)return m;for(var r=this.recognizers,t=0;t<r.length;t++)if(r[t].options.event==m)return r[t];return null},add:function(m){if(g(m,"add",this))return this;var r=this.get(m.options.event);r&&this.remove(r);this.recognizers.push(m);m.manager=this;this.touchAction.update();
return m},remove:function(m){if(g(m,"remove",this))return this;if(m=this.get(m)){var r=this.recognizers;m=w(r,m);-1!==m&&(r.splice(m,1),this.touchAction.update())}return this},on:function(m,r){if(m!==e&&r!==e){var t=this.handlers;h(u(m),function(z){t[z]=t[z]||[];t[z].push(r)});return this}},off:function(m,r){if(m!==e){var t=this.handlers;h(u(m),function(z){r?t[z]&&t[z].splice(w(t[z],r),1):delete t[z]});return this}},emit:function(m,r){this.options.domEvents&&Ea(m,r);var t=this.handlers[m]&&this.handlers[m].slice();
if(t&&t.length)for(r.type=m,r.preventDefault=function(){r.srcEvent.preventDefault()},m=0;m<t.length;)t[m](r),m++},destroy:function(){this.element&&va(this,!1);this.handlers={};this.session={};this.input.destroy();this.element=null}};S(R,{INPUT_START:1,INPUT_MOVE:2,INPUT_END:4,INPUT_CANCEL:8,STATE_POSSIBLE:1,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:1,DIRECTION_LEFT:2,DIRECTION_RIGHT:4,DIRECTION_UP:8,DIRECTION_DOWN:16,DIRECTION_HORIZONTAL:6,
DIRECTION_VERTICAL:24,DIRECTION_ALL:30,Manager:na,Input:F,TouchAction:ia,TouchInput:T,MouseInput:W,PointerEventInput:Z,TouchMouseInput:ha,SingleTouchInput:aa,Recognizer:Q,AttrRecognizer:N,Tap:da,Pan:ca,Swipe:ma,Pinch:ja,Rotate:la,Press:ka,on:q,off:B,each:h,merge:Ga,extend:wa,assign:S,inherit:l,bindFn:n,prefixed:A});("undefined"!==typeof b?b:"undefined"!==typeof self?self:{}).Hammer=R;"function"===typeof define&&define.amd?define(function(){return R}):"undefined"!=typeof module&&module.exports?module.exports=
...
!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,n=0,p=0,q=0;f.animateInterval=function(B,v){k=$.easing.swing(null,n,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,n,f.parameters.height,f.parameters.height*(g-1),20);p=$.easing.swing(null,n,f.parameters.left,
f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);q=$.easing.swing(null,n,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:q+"px"});for(var u=0;u<f.side.pageArray.length;u++)if(f.side.pageArray[u])f.side.pageArray[u].onResize(k/2,l);n++;if(20<=n||B>=v){f.animateInterval.stop();f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-
...
(f.y+=d.parameters.height*e/4),BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var n=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,q=e*k,B=0,v=0,u=0,w=0;toolBar&&(B=0===toolBar.getTopHeight()?
0:toolBar.getTopHeight()+10,v=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,u=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,w=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var x=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-w;l=-l-h*e*d.parameters.zoomArea.left/100+u}else x=-l-h*e*d.parameters.zoomArea.left/100+u,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-w;q>windowHeight?(h=windowHeight-q-n+k*e*d.parameters.zoomArea.bottom/100-
v,d=-n-k*e*d.parameters.zoomArea.top/100+B):(h=-n-k*e*d.parameters.zoomArea.top/100+B,d=windowHeight-q-n+k*e*d.parameters.zoomArea.bottom/100-v);g=Number.between(g,x,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||
...
this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,q){n(p,q,"Sine")}).animation(this,300)}.bind(this),n=function(p,q,B){if(p<q){B=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,q);var v=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,q);p=k(null,p,this.parameters.scale,d-this.parameters.scale,q);q={};q.scale=p;q.tran={x:B,
y:v};B=transformCSS(q);this.css(B)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,
...
f=f[0];void 0==c&&(c=!1);var n=getHost(f.src),p=getHost();if(n&&p!==n){if(g=f.src.replace(n,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(w){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var q=h.getImageData(0,0,k,l),B=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&q){var v=Color(b).split();k=0;for(var u=q.data.length;k<u;k+=4)0<B.data[k+3]&&(q.data[k]!=v.r&&(B.data[k]=q.data[k]/255*v.r),q.data[k+1]!=v.g&&(B.data[k+1]=
q.data[k+1]/255*v.g),q.data[k+2]!=v.b&&(B.data[k+2]=q.data[k+2]/255*v.b));h.putImageData(B,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(w){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(x){}})}}}}};
...
$.fn.speed=function(b){function c(u){u=void 0==u.originalEvent.touches?[u]:u.originalEvent.touches;if(1<u.length)return q=!0;f=h=u[0].pageX;g=k=u[0].pageY;l=new Date;-1!=p&&window.clearInterval(p);p=window.setInterval(function(){f=h;g=k;l=new Date},300)}function d(u){if(-1==p||1==q)return!0;u=void 0==u.originalEvent.touches?[u]:u.originalEvent.touches;h=u[0].pageX;k=u[0].pageY}function e(u){if(-1==p)return!0;u=void 0!=u.originalEvent.touches==0?[u]:u.originalEvent.touches;if(1==q)return q=1<u.length,
!0;n=new Date;u=(n-l)/20;var w=h-f,x=k-g;0==u?v=B=0:(B=w/u,v=x/u);void 0!=b&&b(B,v);window.clearInterval(p);p=-1}var f,g,h,k,l,n,p=-1,q=!1,B=0,v=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(u){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(u){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,n="",p=-1,q,B,v,u=k.length-l;++p<u;)q=k.charCodeAt(p)<<
16,B=k.charCodeAt(++p)<<8,v=k.charCodeAt(++p),q=q+B+v,n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q&63);2==l?(q=k.charCodeAt(p)<<8,B=k.charCodeAt(++p),q+=B,n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<2&63)+"="):1==l&&(q=k.charCodeAt(p),n+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<4&63)+"==");return n},decode:function(k){k=String(k);for(var l=k.length,n=0,p,q,B="",v=-1;++v<l;)q="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(v)),
p=n%4?64*p+q:q,n++%4&&(B+=String.fromCharCode(255&p>>(-2*n&6)));return B},version:"0.1.0"};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return g});else if(c&&!c.nodeType)if(d)d.exports=g;else for(var h in g)g.hasOwnProperty(h)&&(c[h]=g[h]);else b.base64=g})(this);function parsHexToNormalString(b){for(var c="";2<=b.length;)c+=String.fromCharCode(parseInt(b.substring(0,2),16)),b=b.substring(2,b.length);return c}
...
(function(b){function c(v,u){var w=(v&65535)+(u&65535);return(v>>16)+(u>>16)+(w>>16)<<16|w&65535}function d(v,u,w,x,y,A){v=c(c(u,v),c(x,A));return c(v<<y|v>>>32-y,w)}function e(v,u,w,x,y,A,G){return d(u&w|~u&x,v,u,y,A,G)}function f(v,u,w,x,y,A,G){return d(u&x|w&~x,v,u,y,A,G)}function g(v,u,w,x,y,A,G){return d(w^(u|~x),v,u,y,A,G)}function h(v,u){v[u>>5]|=128<<u%32;v[(u+64>>>9<<4)+14]=u;var w=1732584193,x=-271733879,y=-1732584194,A=271733878;for(u=0;u<v.length;u+=16){var G=w;var F=x;var O=y;var L=A;
w=e(w,x,y,A,v[u],7,-680876936);A=e(A,w,x,y,v[u+1],12,-389564586);y=e(y,A,w,x,v[u+2],17,606105819);x=e(x,y,A,w,v[u+3],22,-1044525330);w=e(w,x,y,A,v[u+4],7,-176418897);A=e(A,w,x,y,v[u+5],12,1200080426);y=e(y,A,w,x,v[u+6],17,-1473231341);x=e(x,y,A,w,v[u+7],22,-45705983);w=e(w,x,y,A,v[u+8],7,1770035416);A=e(A,w,x,y,v[u+9],12,-1958414417);y=e(y,A,w,x,v[u+10],17,-42063);x=e(x,y,A,w,v[u+11],22,-1990404162);w=e(w,x,y,A,v[u+12],7,1804603682);A=e(A,w,x,y,v[u+13],12,-40341101);y=e(y,A,w,x,v[u+14],17,-1502002290);
x=e(x,y,A,w,v[u+15],22,1236535329);w=f(w,x,y,A,v[u+1],5,-165796510);A=f(A,w,x,y,v[u+6],9,-1069501632);y=f(y,A,w,x,v[u+11],14,643717713);x=f(x,y,A,w,v[u],20,-373897302);w=f(w,x,y,A,v[u+5],5,-701558691);A=f(A,w,x,y,v[u+10],9,38016083);y=f(y,A,w,x,v[u+15],14,-660478335);x=f(x,y,A,w,v[u+4],20,-405537848);w=f(w,x,y,A,v[u+9],5,568446438);A=f(A,w,x,y,v[u+14],9,-1019803690);y=f(y,A,w,x,v[u+3],14,-187363961);x=f(x,y,A,w,v[u+8],20,1163531501);w=f(w,x,y,A,v[u+13],5,-1444681467);A=f(A,w,x,y,v[u+2],9,-51403784);
y=f(y,A,w,x,v[u+7],14,1735328473);x=f(x,y,A,w,v[u+12],20,-1926607734);w=d(x^y^A,w,x,v[u+5],4,-378558);A=d(w^x^y,A,w,v[u+8],11,-2022574463);y=d(A^w^x,y,A,v[u+11],16,1839030562);x=d(y^A^w,x,y,v[u+14],23,-35309556);w=d(x^y^A,w,x,v[u+1],4,-1530992060);A=d(w^x^y,A,w,v[u+4],11,1272893353);y=d(A^w^x,y,A,v[u+7],16,-155497632);x=d(y^A^w,x,y,v[u+10],23,-1094730640);w=d(x^y^A,w,x,v[u+13],4,681279174);A=d(w^x^y,A,w,v[u],11,-358537222);y=d(A^w^x,y,A,v[u+3],16,-722521979);x=d(y^A^w,x,y,v[u+6],23,76029189);w=d(x^
y^A,w,x,v[u+9],4,-640364487);A=d(w^x^y,A,w,v[u+12],11,-421815835);y=d(A^w^x,y,A,v[u+15],16,530742520);x=d(y^A^w,x,y,v[u+2],23,-995338651);w=g(w,x,y,A,v[u],6,-198630844);A=g(A,w,x,y,v[u+7],10,1126891415);y=g(y,A,w,x,v[u+14],15,-1416354905);x=g(x,y,A,w,v[u+5],21,-57434055);w=g(w,x,y,A,v[u+12],6,1700485571);A=g(A,w,x,y,v[u+3],10,-1894986606);y=g(y,A,w,x,v[u+10],15,-1051523);x=g(x,y,A,w,v[u+1],21,-2054922799);w=g(w,x,y,A,v[u+8],6,1873313359);A=g(A,w,x,y,v[u+15],10,-30611744);y=g(y,A,w,x,v[u+6],15,-1560198380);
x=g(x,y,A,w,v[u+13],21,1309151649);w=g(w,x,y,A,v[u+4],6,-145523070);A=g(A,w,x,y,v[u+11],10,-1120210379);y=g(y,A,w,x,v[u+2],15,718787259);x=g(x,y,A,w,v[u+9],21,-343485551);w=c(w,G);x=c(x,F);y=c(y,O);A=c(A,L)}return[w,x,y,A]}function k(v){var u,w="",x=32*v.length;for(u=0;u<x;u+=8)w+=String.fromCharCode(v[u>>5]>>>u%32&255);return w}function l(v){var u,w=[];w[(v.length>>2)-1]=void 0;for(u=0;u<w.length;u+=1)w[u]=0;var x=8*v.length;for(u=0;u<x;u+=8)w[u>>5]|=(v.charCodeAt(u/8)&255)<<u%32;return w}function n(v){return k(h(l(v),
8*v.length))}function p(v,u){var w=l(v),x=[],y=[];x[15]=y[15]=void 0;16<w.length&&(w=h(w,8*v.length));for(v=0;16>v;v+=1)x[v]=w[v]^909522486,y[v]=w[v]^1549556828;u=h(x.concat(l(u)),512+8*u.length);return k(h(y.concat(u),640))}function q(v){var u="",w;for(w=0;w<v.length;w+=1){var x=v.charCodeAt(w);u+="0123456789abcdef".charAt(x>>>4&15)+"0123456789abcdef".charAt(x&15)}return u}function B(v,u,w){u?w?v=p(unescape(encodeURIComponent(u)),unescape(encodeURIComponent(v))):(v=p(unescape(encodeURIComponent(u)),
unescape(encodeURIComponent(v))),v=q(v)):v=w?n(unescape(encodeURIComponent(v))):q(n(unescape(encodeURIComponent(v))));return v}"function"===typeof define&&define.amd?define(function(){return B}):"object"===typeof module&&module.exports?module.exports=B:b.md5=B})(this);String.prototype.MD5=function(b){return md5(this)};
...
cardBook&&cardBook.show(),c&&thumbnail.fissionAll()}},supports=function(){var b=document.createElement("div"),c=["Khtml","Ms","O","Moz","Webkit"];return function(d){if(d in b.style)return!0;d=d.replace(/^[a-z]/,function(f){return f.toUpperCase()});for(var e=c.length;e--;)if(c[e]+d in b.style)return!0;return!1}}(),getBrowserPre=function(){switch(browserType){case 3:return"-ms-";case 2:return"-moz-";case 1:return"-webkit-";case 4:return"-o-"}},getTransform=function(b){switch(browserType){case 3:var c=
b.style["-ms-transform"];break;case 2:c=b.style["-moz-transform"];break;case 1:c=b.style["-webkit-transform"];break;case 4:c=b.style["-o-transform"];break;default:c=b.style.transform}if(void 0==c||null==c)if(c=b.style.transform,void 0==c||null==c)return Point(0,0);c=c.match(/translate\((.*?)\)/)||c.match(/translate3d\((.*?)\)/);if(null==c||""==c||2>c.length)return Point(0,0);c=c[1].split(", ");return Point(parseInt(c[0],10),parseInt(c[1],10))},getTransformScale=function(b){switch(browserType){case 3:var c=
...
(bookType=BookType.single_book,changeShowBook(bookType),c=flipBook.currentPageIndex,b=!0);bookType==BookType.documentView_book&&windowWidth<windowHeight&&"auto"==bookConfig.showDoublePage&&(bookType=BookType.singleDocumentView_book,changeShowBook(bookType),c=singleDocumentViewBook.currentPageIndex,b=!0);resizeFlipBook();resizeCatalogBook();resizeSlideBook();resizeDocumentViewBook();resizeCardBook();b&&(gotoPageFun(c,!1,"change book type"),global.thumbnail&&thumbnail.clearHighLight(),global.thumbnail&&
thumbnail.setHighLight(c))}}
...
b=!0);bookType==BookType.documentView_book&&windowWidth>=windowHeight&&"auto"==bookConfig.showDoublePage&&(bookType=BookType.singleDocumentView_book,changeShowBook(bookType),c=singleDocumentViewBook.currentPageIndex,b=!0);resizeFlipBook();resizeCatalogBook();resizeSlideBook();resizeDocumentViewBook();resizeCardBook();b&&(gotoPageFun(c,!1,"change book type"),global.thumbnail&&thumbnail.clearHighLight(),global.thumbnail&&thumbnail.setHighLight(c))}
function getStaticAdVisible(){return isPhone()||isPad()||!global.staticAd||!global.staticAd.haveAd||global.staticAd.adPosition?!1:!0}
...
Number.between(b,1,d):b,flippingTime:bookConfig.flippingTime,rightToLeft:bookConfig.RightToLeft,originTotalPageCount:originTotalPageCount,totalPageCount:totalPageCount,topMargin:bookConfig.topMargin,bottomMargin:bookConfig.bottomMargin,leftMargin:bookConfig.leftMargin,rightMargin:bookConfig.rightMargin,isDoublePage:!1};initFlipBook(c,b);initIssuuBook(c,b);initCatalogBook(c,b);initSlideBook(c,b);initDocumentViewBook(c,b);initCardBook(b)}
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this,n=d(h);e[n]&&clearTimeout(e[n]);return new Promise(function(p,q){f[n]||(f[n]=[]);f[n].push({resolve:p,reject:q});e[n]=setTimeout(function(){var B,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:return u.setCatchFinallyBlocks(2,3),u.yield(b.apply(l,h),5);case 5:B=u.yieldResult,f[n].forEach(function(w){return w.resolve(B)});
case 3:u.enterFinallyBlock();delete e[n];delete f[n];u.leaveFinallyBlock(0);break;case 2:v=u.enterCatchBlock(),f[n].forEach(function(w){return w.reject(v)}),u.jumpTo(3)}})},c)})}}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),n=l.getContext("2d");l.width=k.width;l.height=k.height;n.drawImage(k,0,0);for(var p=n.getImageData(0,0,l.width,l.height),q=p.data,B=c?e(c):null,v=d?e(d):{r:0,g:0,b:0,a:0},u=0;u<q.length;u+=4){var w=q[u+3];0===w?(q[u]=v.r,q[u+1]=v.g,q[u+2]=v.b,q[u+3]=void 0!==v.a?v.a:0):0<w&&255>w?B&&(q[u]=Math.round((B.r*w+v.r*(255-w))/255),q[u+1]=Math.round((B.g*w+v.g*(255-w))/255),q[u+2]=Math.round((B.b*w+v.b*(255-w))/255),q[u+3]=255):B&&(q[u]=B.r,
q[u+1]=B.g,q[u+2]=B.b,q[u+3]=void 0!==B.a?B.a:255)}n.putImageData(p,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}
...
var tmpBookConfig={},checkBookConfig=function(){var b,c,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress){b=htmlConfig.bookConfig;c=allocateUTF8(b);window.key_index=Module._DeConfig_Parse(c);void 0==window.aliasConfig&&(window.aliasConfig={});tmpBookConfig.domainAccess=getConfigValue("domainAccess","").toLowerCase();tmpBookConfig.showWatermark=getConfigValue("showWatermark",!1);tmpBookConfig.printWatermark=getConfigValue("printWatermark",!1);tmpBookConfig.watermarkRotation=
...
getConfigValue("flipShortcutButtonColor","");tmpBookConfig.flipShortcutButtonHoverColor=getConfigValue("flipShortcutButtonHoverColor","");tmpBookConfig.flipShortcutButtonBackgroundColor=getConfigValue("flipShortcutButtonBackgroundColor","");tmpBookConfig.flipShortcutButtonHoverBackgroundColor=getConfigValue("flipShortcutButtonHoverBackgroundColor","");tmpBookConfig.isZoomControlBarVisible=getConfigValue("isZoomControlBarVisible",!0);tmpBookConfig.power_info=getConfigValue("power_info",null);tmpBookConfig.autoFlipPageOnTimelineEnd=
getConfigValue("autoFlipPageOnTimelineEnd",!1);tmpBookConfig.autoFlipPageOnTimelineEnd=getConfigValue("autoFlipPageOnTimelineEnd",!1);tmpBookConfig.homeButtonOpenWindowType=getConfigValue("homeButtonOpenWindowType","Chinese"==UserGroups?"_self":"_blank").toLowerCase();tmpBookConfig.homeButtonOpenWindowType.startsWith("_")||(tmpBookConfig.homeButtonOpenWindowType="_"+tmpBookConfig.homeButtonOpenWindowType);tmpBookConfig.isFirstLastShortcutVisible=getConfigValue("isFirstLastShortcutVisible",!0);tmpBookConfig.miniFullscreenDisplayType=
getConfigValue("miniFullscreenDisplayType","always").toLowerCase();tmpBookConfig.isFakeStopBook=getConfigValue("isFakeStopBook",0);tmpBookConfig.isTabelOfContentSearchBarVisible=getConfigValue("isTabelOfContentSearchBarVisible",!0);tmpBookConfig.mouseDragFlip=getConfigValue("mouseDragFlip",!0);tmpBookConfig.disablePrintShortcut=getConfigValue("disablePrintShortcut",!1);tmpBookConfig.chatBotButtonIconHeight=getConfigValue("chatBotButtonIconHeight",56);tmpBookConfig.chatBotButtonIcon=getConfigValue("chatBotButtonIcon",
"");tmpBookConfig.isAccessibilityButtonVisible=getConfigValue("isAccessibilityButtonVisible",!1);tmpBookConfig.ClientBookId=getConfigValue("ClientBookId","");tmpBookConfig.CreatedTime=getConfigValue("CreatedTime","");tmpBookConfig.CreatedVersion=getConfigValue("CreatedVersion","");tmpBookConfig.productName=getConfigValue("productName","");tmpBookConfig.productVersion=getConfigValue("productVersion","");tmpBookConfig.PDFBASE_VERSION_MAC=getConfigValue("PDFBASE_VERSION_MAC","");tmpBookConfig.PDFBASE_VERSION=
getConfigValue("PDFBASE_VERSION","");tmpBookConfig.isCachePages=getConfigValue("isCachePages",!1);tmpBookConfig.displayNumberOfShares=getConfigValue("displayNumberOfShares",!1);tmpBookConfig.additionalNumberOfShare=getConfigValue("additionalNumberOfShare",0);tmpBookConfig.flipSoundURL=getConfigValue("flipSoundURL","");tmpBookConfig.isTableOfContentPagesVisible=getConfigValue("isTableOfContentPagesVisible",!1);tmpBookConfig.isArticlePhoneMoreButtonVisible=getConfigValue("isArticlePhoneMoreButtonVisible",
!1);tmpBookConfig.alwaysShowBottomFullscreenPrompt=getConfigValue("alwaysShowBottomFullscreenPrompt",!1);tmpBookConfig.bottomFullscreenPromptDisplayDuration=getConfigValue("bottomFullscreenPromptDisplayDuration",3);tmpBookConfig.isChatBotButtonVisible=getConfigValue("isChatBotButtonVisible",!1);tmpBookConfig.articleTitlePosition=getConfigValue("articleTitlePosition","center").toLocaleLowerCase();tmpBookConfig.phoneFlipShortcutButtonSize=getConfigValue("phoneFlipShortcutButtonSize","large").toLocaleLowerCase();
tmpBookConfig.isRestorePageFrameVisible=getConfigValue("isRestorePageFrameVisible",!0);tmpBookConfig.alwaysShowBookInstructionOnStart=getConfigValue("alwaysShowBookInstructionOnStart","0");tmpBookConfig.showBookInstructionCountOnStart=getConfigValue("showBookInstructionCountOnStart",3);tmpBookConfig.toolBarBrandInfoVisible=getConfigValue("toolBarBrandInfoVisible",
...
getConfigValue("isFixLogoSize",!1);tmpBookConfig.HomeButtonVisible=getConfigValue("HomeButtonVisible",!1);tmpBookConfig.facebookAppId=getConfigValue("facebookAppId","");tmpBookConfig.isInsertFrameLinkEnable=getConfigValue("isInsertFrameLinkEnable",!0);tmpBookConfig.DoubleSinglePageButtonVisible=getConfigValue("DoubleSinglePageButtonVisible",!1);tmpBookConfig.ToolBarVisible=
getConfigValue("ToolBarVisible",!0);tmpBookConfig.ThumbnailsButtonVisible=getConfigValue("ThumbnailsButtonVisible",!1);tmpBookConfig.thumbnailColor=getConfigValue("thumbnailColor",tmpBookConfig.formBackgroundColor);tmpBookConfig.thumbnailAlpha=getConfigValue("thumbnailAlpha",100);tmpBookConfig.ThumbnailSize=getConfigValue("ThumbnailSize","small");tmpBookConfig.ZoomButtonVisible=getConfigValue("ZoomButtonVisible",
...
function setBookVerticalMargin(b){b=void 0===b?{}:b;try{var c=global.staticAd&&global.staticAd.haveAd&&"Chinese"!=UserGroups&&global.staticAd.adPosition?!0:!1,d=global.staticAd.height||90,e=tmpBookConfig.ORIGIN_TOP_MARGIN,f,g,h,k=null!=(h=null!=(g=b.bookmarkHeight)?g:null==(f=BookInfo.getAttachmentByName("Bookmarktab"))?void 0:f.getHeight())?h:0;!bmtConfig.onSideEdge&&0<k&&e<k&&(e=k+5);if(c&&2==global.staticAd.adPosition)if(e<d+20)e+=d+20;else{var l=BookInfo.top()-templateArea.getTopHeight();e=Math.max(e,
l)}tmpBookConfig.topMargin=e;var n=tmpBookConfig.ORIGIN_BOTTOM_MARGIN;c&&1==global.staticAd.adPosition&&n<d+20&&(n+=d+20);tmpBookConfig.bottomMargin=n;b.disableResize||"function"!=typeof global.onStageResize||onStageResize()}catch(p){console.log("setBookVerticalMargin error",p)}}
...
chooseBookStyle:function(){var b=this.getBookTye();"normal_book"==b?this.init():this.initBookStyle(b)},initBookStyle:function(b){switch(b){case "documentView_book":this.setBookTye(BookType.singleDocumentView_book);initBookFrame();break;case "slide_book":bookConfig.FlipDirection?windowWidth<windowHeight&&"auto"==bookConfig.showDoublePage||"double"==bookConfig.showDoublePage?this.setBookTye(BookType.slide_book):this.setBookTye(BookType.singleSlide_book):windowWidth>windowHeight&&"auto"==bookConfig.showDoublePage||
"double"==bookConfig.showDoublePage?this.setBookTye(BookType.slide_book):this.setBookTye(BookType.singleSlide_book);initBookFrame();break;case "flip_book":bookType=bookConfig.FlipDirection?windowWidth<windowHeight&&"auto"==bookConfig.showDoublePage||"double"==bookConfig.showDoublePage?BookType.normal_book:BookType.single_book:windowWidth>windowHeight&&"auto"==bookConfig.showDoublePage||"double"==bookConfig.showDoublePage?BookType.normal_book:BookType.single_book;initBookFrame();break;case "catalog_book":bookType=
BookType.catalog_book;initBookFrame();break;case "card_book":bookType=BookType.card_book,this.setBookTye(bookType),initBookFrame()}},getBookTye:function(){var b="normal_book";if("slide"==bookConfig.FlipStyle.toLowerCase()||isBelowIE9())b="slide_book";"flip"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="flip_book");"issuu"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="flip_book");""!=bookConfig.FlipStyle||isBelowIE9()||(b="flip_book");"catalog"!=bookConfig.FlipStyle.toLowerCase()||
isBelowIE9()||(b="catalog_book");"docview"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="documentView_book");"card"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="card_book");return b},setBookTye:function(b){window.bookType=b},init:function(){this.container=$("<div class='book_style_choose_container'></div>");this.bookStyleBox=$("<div class='book_style_box'></div>");this.container.css({"background-color":this.backgroundColor});this.parent.append(this.container);this.container.append(this.bookStyleBox);
...
function getArticleEditor(){function b(w){if(window.isExecuteGetInverseEditor)var x=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(x),w()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),w(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(y){d(y,w)},w,"")}function c(w,x,y,A,G){var F=new XMLHttpRequest;F.responseType=
void 0===A?"json":A;F.open("GET",w);F.send();F.onreadystatechange=function(){4===F.readyState&&(200===F.status||304===F.status?x&&x(F):"bookinfo"===G&&x?x():y&&y(x))};F.error=function(){y&&y(x)}}function d(w,x){u&&(clearTimeout(u),u=null);if(window.Module.isReady){var y=allocateUTF8(w.responseText),A=Module._DeString(y),G=UTF8ToString(A);G=eval(G);Module._free(y);Module._FreeMemory(A);e(G);x();window.runArticleEditor&&delete window.runArticleEditor}else u=setTimeout(function(){d(w,x)},100)}function e(w){(window.articleListConfig=
w)?g(w):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&p(function(w){window.articleConfig=w.response})}function g(w){for(var x=[],y=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],G=0;G<y;G++){for(var F=A&&A.length&&A[G]?A[G].index:G,O=[],L=0;L<w.length;L++)(w[L].articles?w[L].articles:[]).forEach(function(H){if(H.isShowLinkSplited){if(H.articleTextList&&
...
x:I.rect.x,y:I.rect.y,width:I.rect.width,height:I.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:I.rect.pageWidth,pageHeight:I.rect.pageHeight}:""}I&&H.articleTextList&&H.articleTextList.length&&(H=k(H),M=h(H,I),O.push(M))}});x.push(O)}console.log("currentPageEditor",JSON.parse(JSON.stringify(x)));window.inverseEditor=x}function h(w,x){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
downColor:"#4997ee",outColor:"#4997ee",overAlpha:"0.3",downAlpha:"0.5",outAlpha:"0"});var y=window.articleConfig.hotArea;return{action:{triggerEventType:"mouseDown",actionType:"com.mobiano.flipbook.pageeditor.TAnnoActionShowArticle",articleConfig:w,linkTarget:"showArticle"},annotype:"com.mobiano.flipbook.pageeditor.TAnnoLink",annoId:"202211710188056",isInverse:!0,alpha:"1",overColor:y.overColor,downColor:y.downColor,outColor:y.outColor,overAlpha:y.overAlpha,downAlpha:y.downAlpha,outAlpha:y.outAlpha,
pageViewedBool:"true",ellipseH:"0",ellipseW:"0",location:x,hint:{hintShapeColor:"0",hintShapeColor2:"8388736",hintShapeAlpha:"1",hintW:"0",hintH:"0",hintAuto:"true",hintShapeType:"2",text:""},shadow:{hasDropShadow:"false",shadowDistance:"4",shadowAngle:"270",shadowColor:"0",shadowAlpha:"0.6",shadowBlurX:"4",shadowBlurY:"4"},highlightsBool:"false",linkStatus:"1",mouseOver:"false",borderColor:"16737792"}}function k(w){w=JSON.parse(JSON.stringify(w));w.articleTextList.map(function(x){"text"===x.type&&
(x.text=x.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return x});return{articleId:w.articleId,newTime:w.newTime,title:w.title,subTitle:w.subTitle,author:w.author,categoryId:w.categoryId,articleTextList:w.articleTextList}}function l(w,x){var y=[];w.forEach(function(A){-1!==x&&(A.pageIndex===x||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(G){return G.pageIndex===x}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,x),A.length&&(y=[].concat($jscomp.arrayFromIterable(y),$jscomp.arrayFromIterable(A)))):
y.push(A.rect))});return y}function n(w,x){var y="";w.forEach(function(A){if(-1!==x&&(A.pageIndex===x||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===x}).length))if(""===y)y=A.mergeList&&A.mergeList.length?n(A.mergeList,x):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var G=[y].concat(A.mergeList);y=n(G,x)}y.rect.x>A.rect.x&&(y.rect.x=A.rect.x);y.rect.y>A.rect.y&&(y.rect.y=A.rect.y);y.rect.endX<A.rect.endX&&(y.rect.endX=A.rect.endX);y.rect.endY<
A.rect.endY&&(y.rect.endY=A.rect.endY);y.rect.width=y.rect.endX-y.rect.x;y.rect.height=y.rect.endY-y.rect.y}});return y}function p(w){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,w,q):q(w)}function q(w){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,w,B):B(w)}function B(w){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var x=bookConfig.periodsConfigPath;x=x.replace("%periodicalId%",window.book_visit.periodicalId);c(x,w,v)}else v(w)}
function v(w){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,w):w&&w()}var u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){return w.return(new Promise(function(x,y){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?x():window.runArticleEditor||window.inverseEditor?x():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(y=bookConfig.bookBaseURL)?(y.endsWith("/")||(y+="/"),c(y+"bookinfo.js",function(A){A&&A.response&&
...
(this.texture.remove(),this.texture=null);this.top_texture&&(this.top_texture.remove(),this.top_texture=null);this.left_texture&&(this.left_texture.remove(),this.left_texture=null);this.right_texture&&(this.right_texture.remove(),this.right_texture=null);this.bottom_texture&&(this.bottom_texture.remove(),this.bottom_texture=null);this.left_texture_border&&(this.left_texture_border.remove(),this.left_texture_border=null);this.top_texture_border&&(this.top_texture_border.remove(),this.top_texture_border=
null);this.right_texture_border&&(this.right_texture_border.remove(),this.right_texture_border=null);this.bottom_texture_border&&(this.bottom_texture_border.remove(),this.bottom_texture_border=null)}}),NormalPageTexture=Class({create:function(b,c,d){this._super(b,c,d);this.isOutCover=1==c&&!bookConfig.isTheBookOpen||c==totalPageCount;this.isInnerCover=2==c&&!bookConfig.isTheBookOpen||1==c&&bookConfig.isTheBookOpen||c==totalPageCount-1;this.isCover=this.isOutCover||this.isInnerCover}}).extend("PageTexture"),
SinglePageTexture=Class({create:function(b,c,d){this._super(b,c,d);this.isOutCover=1==c;this.isInnerCover=c==bookConfig.totalPageCount;this.isCover=this.isOutCover||this.isInnerCover}}).extend("PageTexture"),CatalogPageTexture=Class({create:function(b,c,d){this._super(b,c,d);this.isOutCover=1==c&&!bookConfig.isTheBookOpen||c==totalPageCount;this.isInnerCover=2==c&&!bookConfig.isTheBookOpen||1==c&&bookConfig.isTheBookOpen||c==totalPageCount-1;this.isCover=this.isOutCover||this.isInnerCover}}).extend("PageTexture"),
SlidePageTexture=Class({create:function(b,c,d){this._super(b,c,d);this.isCover=!1}}).extend("PageTexture"),DocViewPageTexture=Class({create:function(b,c,d){this._super(b,c,d);this.isCover=!1}}).extend("PageTexture"),CardPageTexture=Class({create:function(b,c,d){this._super(b,c,d);this.isCover=!1}}).extend("PageTexture"),BorderSewing={deep:{top:{url:"deep_top_sewing.png",width:28,height:42},left:{url:"deep_left_sewing.png",width:71,height:28},right:{url:"deep_right_sewing.png",width:71,height:28},
bottom:{url:"deep_bottom_sewing.png",width:28,height:42},renderBorder:!0},normal:{top:{url:"normal_top_sewing.png",width:28,height:10},left:{url:"normal_left_sewing.png",width:10,height:28},right:{url:"normal_right_sewing.png",width:10,height:28},bottom:{url:"normal_bottom_sewing.png",width:28,height:20},renderBorder:!0},flat:{top:{url:"flat_top_sewing.png",width:28,height:10},left:{url:"flat_left_sewing.png",width:10,height:28},right:{url:"flat_right_sewing.png",width:10,height:28},bottom:{url:"flat_bottom_sewing.png",
width:28,height:10},renderBorder:!1}},PageTextureResource={leather1:{texture:"leather1.png",sewing:BorderSewing.deep},leather2:{texture:"leather2.png",sewing:BorderSewing.normal},cloth1:{texture:"cloth1.png",sewing:BorderSewing.flat},cloth2:{texture:"cloth2.png",sewing:BorderSewing.flat},cloth3:{texture:"cloth3.png",sewing:BorderSewing.flat},cloth4:{texture:"cloth4.png",sewing:BorderSewing.normal},cardboard1:{texture:"cardboard1.png",sewing:null},cardboard2:{texture:"cardboard2.png",sewing:null},
cardboard3:{texture:"cardboard3.png",sewing:null},silk1:{texture:"silk1.png",sewing:BorderSewing.flat},silk2:{texture:"silk2.png",sewing:BorderSewing.flat},silk3:{texture:"silk3.png",sewing:BorderSewing.flat},silk4:{texture:"silk4.png",sewing:BorderSewing.flat},wood1:{texture:"wood1.png",sewing:null},wood2:{texture:"wood2.png",sewing:null}},PageRendering=Class({create:function(b,c,d){this.parent=b;this.pageIndex=c;this.isLeftPage=getPageDirection(c,d);this.pageShadow=getPageShadow(b,c,this.isLeftPage,
d);this.pageTexture=getPageTexture(b,c,this.isLeftPage,d);this.grayshadow=getGrayShadow(b,c,this.isLeftPage,d)},render:function(){this.addCoil();this.addPageShadow();this.addPageTexture()},addCoil:function(){if("loose2"==bookConfig.BindingType)this.addCoil2();else if(parseBool(bookConfig.addPaperCoil)){var b=$("<div class='coil'></div>");this.midCoil=$("<div style='z-index:6;'></div>");bookConfig.FlipDirection?this.isLeftPage?(b.attr("class","upPaperCoil"),this.midCoil.attr("class","upPaperCoil_bg")):
(b.attr("class","downPaperCoil"),this.midCoil.attr("class","downPaperCoil_bg")):this.isLeftPage?(b.attr("class","leftPaperCoil"),this.midCoil.attr("class","leftPaperCoil_bg")):(b.attr("class","rightPaperCoil"),this.midCoil.attr("class","rightPaperCoil_bg"));this.midCoil.append(b);!bookConfig.HardPageEnable||1!=this.pageIndex&&this.pageIndex!=totalPageCount||this.midCoil.css("background-image","none");this.parent.append(this.midCoil)}},addCoil2:function(){if(parseBool(bookConfig.addPaperCoil)){var b=
$("<div class='coil'></div>");this.midCoil=$("<div style='z-index:6;'></div>");bookConfig.FlipDirection?this.isLeftPage?(b.attr("class","upPaperCoil2"),this.midCoil.attr("class","upPaperCoil2_bg")):(b.attr("class","downPaperCoil2"),this.midCoil.attr("class","downPaperCoil2_bg")):this.isLeftPage?(b.attr("class","leftPaperCoil2"),this.midCoil.attr("class","leftPaperCoil2_bg")):(b.attr("class","rightPaperCoil2"),this.midCoil.attr("class","rightPaperCoil2_bg"));this.midCoil.append(b);this.midCoil.append(b.clone());
!bookConfig.HardPageEnable||1!=this.pageIndex&&this.pageIndex!=totalPageCount||this.midCoil.css("background-image","none");this.parent.append(this.midCoil)}},addPageShadow:function(){this.pageShadow.addShadow()},addPageTexture:function(){this.pageTexture.render()},hideMiddleShadow:function(){this.pageShadow.hidePageShadow()},onResize:function(b,c){if(this.pageShadow)this.pageShadow.onResize(b,c);if(this.pageTexture)this.pageTexture.onResize(b,c);this.midCoil&&(bookConfig.FlipDirection?this.resizeCoilVertical(b,
c):(!bookConfig.HardPageEnable||2!=this.pageIndex&&this.pageIndex!=totalPageCount-1||this.midCoil.css({height:c+"px",top:0,bottom:0,margin:"auto"}),"loose2"==bookConfig.BindingType?(b=Math.min(60*parseInt(c/3/60),180),this.midCoil.find("div").css({height:b+"px"}),$(this.midCoil.find("div")[0]).css({top:"67%","margin-top":"-30px",bottom:"auto"}),$(this.midCoil.find("div")[1]).css({bottom:"67%","margin-bottom":"-30px",top:"auto"})):(b=50*parseInt(c/50),this.midCoil.find("div").css({height:b+"px"}))))},
resizeCoilVertical:function(b,c){!bookConfig.HardPageEnable||2!=this.pageIndex&&this.pageIndex!=totalPageCount-1||this.midCoil.css({width:b+"px",left:0,right:0,margin:"auto"});"loose2"==bookConfig.BindingType?(b=Math.min(60*parseInt(b/3/60),180),this.midCoil.find("div").css({width:b+"px"}),$(this.midCoil.find("div")[0]).css({left:"67%","margin-left":"-30px",right:"auto"}),$(this.midCoil.find("div")[1]).css({right:"67%","margin-right":"-30px",left:"auto"})):(b=50*parseInt(b/50),this.midCoil.find("div").css({width:b+
"px"}))},destroy:function(){this.pageShadow&&(this.pageShadow.destroy(),this.pageShadow=null);this.pageTexture&&(this.pageTexture.destroy(),this.pageTexture=null);this.midCoil&&(this.midCoil.remove(),this.midCoil=null)}});function getGrayShadow(b,c,d,e){if(!_agent_.browser.msie&&!_agent_.browser.safari&&bookConfig.ShowTopLeftShadow&&e==BookType.normal_book&&d)return new GrayShadow(b)}
...
function getPageDirection(b,c){switch(c){case BookType.single_book:if(bookConfig.RightToLeft)return!0;break;case BookType.singleSlide_book:if(bookConfig.RightToLeft)return!0;break;default:return BookInfo.isLeftPage(b,!0)}return!1}
...
return accessControlImagesPool[f]?[]:c}}}),adjustPageURL=function(b,c,d){b=parseInt(b)-1;global.fliphtml5_pages||(global.fliphtml5_pages=[]);global.fliphtml5_pages[b]||(global.fliphtml5_pages[b]={});switch(c){case 0:global.fliphtml5_pages[b].l=d;break;case 1:global.fliphtml5_pages[b].n=d;break;case 2:global.fliphtml5_pages[b].t=d;break;case 3:global.fliphtml5_pages[b].p=d}},useTheFliphtml5Service=function(){if(bookConfig.useTheFliphtml5Service)for(var b=bookConfig.totalPageCount,c=1;c<=b;c++){var d=
pageDirWidthPath(c,"normal",b),e=pageDirWidthPath(c,"large",b),f=pageDirWidthPath(c,"thumb",b),g=pageDirWidthPath(c,"previewPage",b);if("string"!=typeof d)for(var h=0;h<d.length;h++)d[h]=resetFliphtml5URL(d[h]);else d=resetFliphtml5URL(d);e=resetFliphtml5URL(e);f=resetFliphtml5URL(f);g=resetFliphtml5URL(g);adjustPageURL(c,0,e);adjustPageURL(c,1,d);adjustPageURL(c,2,f);adjustPageURL(c,3,g)}},useTheAliCloudChart=function(b,c){if(bookConfig.useTheAliCloudChart){if(isPad()||isPhone())try{b*=devicePixelRatio,
c*=devicePixelRatio}catch(n){}for(var d=bookConfig.totalPageCount,e=1;e<=d;e++){var f=realPageDir(e,"normal",d),g=realPageDir(e,"large",d),h=realPageDir(e,"thumb",d),k=realPageDir(e,"previewPage",d);if("string"!=typeof f)for(var l=0;l<f.length;l++)f[l]=resetYunzhanURL(f[l],b,c);else f=resetYunzhanURL(f,b,c);g=resetYunzhanURL(g);h=resetYunzhanURL(h);k=resetYunzhanURL(k);adjustPageURL(e,0,g);adjustPageURL(e,1,f);adjustPageURL(e,2,h);adjustPageURL(e,3,k)}}},useTheAliCloudChartOnIsuuBook=function(b,c){if(bookConfig.useTheAliCloudChart&&
"issuu"==bookConfig.FlipStyle)for(var d=bookConfig.totalPageCount,e=1;e<=d;e++){var f=realPageDir(e,"normal",d),g=realPageDir(e,"large",d),h=realPageDir(e,"thumb",d),k=realPageDir(e,"previewPage",d);c=BookInfo.getBook().getPagesFitWHByIndex(e);b=c.x;c=c.y;if(isPad()||isPhone())try{b*=devicePixelRatio,c*=devicePixelRatio}catch(n){}if("string"!=typeof f)for(var l=0;l<f.length;l++)f[l]=resetYunzhanURL(f[l],b,c);else f=resetYunzhanURL(f,b,c);g=resetYunzhanURL(g);h=resetYunzhanURL(h);k=resetYunzhanURL(k);
adjustPageURL(e,0,g);adjustPageURL(e,1,f);adjustPageURL(e,2,h);adjustPageURL(e,3,k)}};
...
var globalImages=[],canvasData=[],canvasLoad=function(b,c,d,e,f,g){var h=$("<canvas class='test'></canvas>"),k=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){e&&e(c,c,h,b);l.jumpToEnd()})};(function(){var l=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){$.ajax({url:c,type:"GET",dataType:"json",success:function(p){canvasData[b]="string"==typeof p?JSON.parse(p):p;globalImages[b]=[];(function(){if(0==canvasData[b].resources.length)k();else for(var q=0,
B=0;B<canvasData[b].resources.length;B++)if(1!=canvasData[b].resources[B].type)q++,q>=canvasData[b].resources.length&&k();else{var v=new Image;v.src=getResource(b,B);globalImages[b][B]=v;v.onload=function(){q++;q>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});n.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,n,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(v){bookConfig.largePageWidth/bookConfig.largePageHeight>v[0].naturalWidth/v[0].naturalHeight?v.css({width:"auto",height:"100%"}):v.css({width:"100%",height:"auto"})};for(n=0;n<c.length;n++)p=c[n],p=p.removeStartFrom("?"),q=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),q.attr("src",p),k.append(q),q[0].onload=function(v){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},q[0].onerror=function(v){h++;h==c.length&&
e&&e(c,c,k,b)};B.jumpToEnd()})},noneLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){h=$("<div style='width:100%;height:100%;background:"+bookConfig.pageBackgroundColor+";'></div>");e&&e(c,c,h,b);return k.return()})},jsLoad=function(b,c,d,e,f,g){var h,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){h=function(q,B){return!q||passwardType()&&bookConfig.excludeFrontPages&&B>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),p.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),n=$("<img src='"+l+"'/>"),n[0].onload=function(){e&&e(l,c,this,b)},p.return();loadJavascript(c,function(q){var B=dataBase64Str(b,d,q);$("<img src='"+B+"'/>")[0].onload=function(){e&&e(B,c,this,b)}},function(){});
return p.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(!window.printLoadStack)return p.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;n=new PdfLoadingTask(b,d,k,l,function(q){var B=q.toDataURL("image/png"),v=$("<img src='"+B+"'/>");v[0].onload=function(){e&&e(B,B,v,b)}}.bind(h));window.printLoadStack.push(n);return p.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
JsLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,q.yield(getPageDir(b,c,originTotalPageCount),2);k=q.yieldResult;h.imageURL=k;if(!h.fillImageOrNot(k,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),
function(){this.create(b,c,d)}.bind(h),function(){}),q.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return n=dataBase64Str(b,c),h.$image=$("<img src='"+n+"'/>"),h.$image[0].onload=function(){d&&d(n,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),q.return();p=h;loadJavascript(k,function(B){var v=dataBase64Str(b,c,B);p.$image=$("<img src='"+
...
k=this.loadAllImage;(function(){var l=this,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return p.yield(getPageDir(b,c,originTotalPageCount),2);n=p.yieldResult;$.ajax({url:n,type:"get",async:!1,success:function(q){canvasData[b]=configForPages.pages[b-1].data;globalImages[b]=[];k(b,h)}.bind(l),error:function(){}});p.jumpToEnd()})})()},loadAllImage:function(b,c){for(var d=0,e=0;e<canvasData[b].resources.length;e++)if(1!=canvasData[b].resources[e].type)d++,d>=canvasData[b].resources.length&&
c();else{var f=new Image;f.src=getResource(b,e);globalImages[b][e]=f;f.onload=function(){d++;d>=canvasData[b].resources.length&&c()}}},zoomIn:function(){},zoomOut:function(){},onResize:function(){},renderCnvas:function(b,c,d,e,f,g,h){if(bookConfig.usePdfJs&&d){this.renderInterval&&(window.clearInterval(this.renderInterval),this.renderInterval=void 0);this.render&&(this.render.taskPool.stop(),this.render=void 0);var k=canvasData[e],l=k.page,n=f,p=g,q=f/g,B=l.width/l.height;.01<=q-B&&!PageInfo.pageIsStrech(this.pageIndex)&&
(n=l.width*g/l.height);-.01>=q-B&&!PageInfo.pageIsStrech(this.pageIndex)&&(p=f*l.height/l.width);if(!window.devicePixelRatio||isPC())window.devicePixelRatio=1;f=n*devicePixelRatio/l.width;d.attr("width",n*devicePixelRatio);d.attr("height",p*devicePixelRatio);d.css("height",p+"px");d.css("width",n+"px");d.css({position:"absolute",top:0,bottom:0,left:0,right:0,margin:"auto"});g=d[0].getContext("2d");g.save();g.imageSmoothingEnabled=!0;l.background&&(g.fillStyle=int2color(l.background),g.fillRect(0,
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),n=Math.ceil(k/2),p=b.getContext("2d"),q=p.getImageData(0,0,f,g),B=p.createImageData(c,d);q=q.data;for(var v=B.data,u=0;u<d;u++)for(var w=0;w<c;w++){for(var x=4*(w+u*c),y,A=0,G=0,F=0,O=0,L=0,H=0,I=(u+.5)*k,K=Math.ceil((u+1)*k),M=Math.floor(u*k);M<K;M++){var W=Math.abs(I-(M+.5))/n,Z=(w+.5)*h;W*=W;for(var aa=Math.ceil((w+1)*h),T=Math.floor(w*h);T<aa;T++)if(y=Math.abs(Z-(T+.5))/l,y=
Math.sqrt(W+y*y),!(1<=y)){y=2*y*y*y-3*y*y+1;var U=4*(T+M*f);H+=y*q[U+3];G+=y;255>q[U+3]&&(y=y*q[U+3]/250);F+=y*q[U];O+=y*q[U+1];L+=y*q[U+2];A+=y}}v[x]=F/A;v[x+1]=O/A;v[x+2]=L/A;v[x+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(B,0,0)}
...
this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),ImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var n=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){n.index=b;n.type=d;n.i=l;n.callback=e;n.errorCallback=f;n.pageWidth=g;n.pageHeight=h;n.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));n.imageURL=
...
TileStrategy.prototype.draw=function(b,c){for(var d=c.width+c.spacing,e=c.height+c.spacing,f=b.canvas.width/2,g=b.canvas.height/2,h=Math.ceil(b.canvas.width/d)+2,k=Math.ceil(b.canvas.height/e)+2,l=-Math.floor(k/2);l<Math.ceil(k/2);l++)for(var n=-Math.floor(h/2);n<Math.ceil(h/2);n++)WatermarkStrategy.prototype.drawSingleWatermark.call(this,b,f+n*d+c.spacing/2,g+l*e+c.spacing/2,c.rotation,c)};var PageEdgeStrategy=function(){WatermarkStrategy.apply(this,arguments)};
...
2-c.width/2,b.canvas.height/2-c.height/2,c.rotation,c)):(e=function(k,l,n,p,q){q=void 0===q?!1:q;var B=h[n],v=Math.abs(l-k);if(!(0>=v)){p=p?B.width:B.height;l=0;if(v>=p)for(l=Math.floor((v+c.spacing)/(p+c.spacing));0<l&&!(l*p+(l-1)*c.spacing<=v);)l--;if(!(0>=l)){v=1<l?(v-l*p)/(l-1):0;for(var u=0;u<l;u++){var w=q?k-u*(p+v):k+u*(p+v),x=void 0,y=void 0;switch(n){case "top":x=w+(B.width-c.width)/2;y=(B.height-c.height)/2+f;break;case "right":x=b.canvas.width-(c.width+B.width)/2-f;y=w+(B.height-c.height)/
2;break;case "bottom":x=w+(B.width-c.width)/2;y=b.canvas.height-(c.height+B.height)/2-f;break;case "left":x=(B.width-c.width)/2+f,y=w+(B.height-c.height)/2}WatermarkStrategy.prototype.drawSingleWatermark.call(d,b,x,y,g[n],c,q)}}}},e(f,b.canvas.width-h.right.width-f,"top",!0,!1),e(f,b.canvas.height-h.bottom.height-f,"right",!1,!1),e(h.left.width,b.canvas.width-f,"bottom",!0,!1),e(h.top.height,b.canvas.height-f,"left",!1,!1))};var WatermarkStrategyFactory=function(){};
...
25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,q){n(p,q,"Sine")}.animation(this,l)}.bind(this);var n=function(p,q,B){if(!b)return!1;var v=b.pageWidth,u=b.pageHeight,w=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(B=w(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(u*u-B*B):u-f*Math.sqrt(v*v-B*B));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,
...
Math.pow(f.x-0,2))>g&&(h=Math.atan((f.y-0)/(f.x-0)),k=Math.abs(Math.cos(h)*g),f.y=Math.abs(Math.sin(h)*g),f.x=0<f.x?k:-k);var l=(f.y-e.y)/(f.x-e.x),n=Math.atan(l);g=180*n/Math.PI;var p=(f.x+e.x)/2,q=(f.y+e.y)/2;h=b/2;k=c/2;0>e.x&&(g+=180,h=-b/2);f=Math.sqrt(Math.pow(e.y-f.y,2)+Math.pow(e.x-f.x,2))/2;f=0<=g&&180>g?Math.abs((c-Math.abs(e.y))*Math.sin(n))+f:Math.abs(e.y*Math.sin(n))+f;d=Math.abs(f/(Math.sin(Math.atan(b/c)+Math.abs(n))*d));d=Math.min(1,d);e=((p-h)*l+k+Math.pow(l,2)*q)/(1+Math.pow(l,2));
...
1,!1,b);break;case BookType.card_book:gotoPageFun(parseInt(cardBook.getCurrentPageIndex())+1,!1,b)}},previousPageFun=function(b){switch(bookType){case BookType.normal_book:gotoPageFun(BookInfo.getMaxPageIndex(flipBook.getCurrentPageIndex())-2,!1,b);break;case BookType.catalog_book:gotoPageFun(BookInfo.getMaxPageIndex(catalogBook.getCurrentPageIndex())-2,!1,b);break;case BookType.single_book:gotoPageFun(parseInt(singlePageBook.currentPageIndex)-1,!1,b);break;case BookType.slide_book:gotoPageFun(BookInfo.getMaxPageIndex(slideBook.getRealPageIndex())-
2,!1,b);break;case BookType.singleSlide_book:gotoPageFun(singleSlideBook.getRealPageIndex()-1,!1,b);break;case BookType.singleCatalog_book:gotoPageFun(parseInt(singleCatalogBook.currentIndex)-1,!1,b);break;case BookType.documentView_book:gotoPageFun(BookInfo.getMinPageIndex(singleDocumentViewBook.getRealPageIndex())-2,!1,b);break;case BookType.singleDocumentView_book:gotoPageFun(parseInt(singleDocumentViewBook.getRealPageIndex())-1,!1,b);break;case BookType.card_book:gotoPageFun(parseInt(cardBook.getCurrentPageIndex())-
1,!1,b)}},firstPageFun=function(b){gotoPageFun(1,!1,b)},lastPageFun=function(b){gotoPageFun(originTotalPageCount,!1,b)},delayToFlipFirstTimer=null,gotoPageFun=function(b,c,d){if(!(isNaN(b)||BookEvent.trigger("beforeFlipPage",[b])||(window.hashGotoPageTimer&&clearTimeout(window.hashGotoPageTimer),gotoPageVisit(b,d),BookEvent.suspendFlipPage&&0<=BookInfo.getCurrentPagesByIndex(b).indexOf(parseInt(BookEvent.suspendFlipPage))))){b=parseInt(b);var e=bookConfig.totalPageCount;bookConfig.SingleModeBanFlipToLastPage&&
bookType==BookType.single_book&&(e=Math.max(1,bookConfig.totalPageCount-1));if(1>b&&bookConfig.isShowFirstOrLastPagePrompt||b>e&&bookConfig.isShowFirstOrLastPagePrompt){if(0>BookInfo.getCurrentPages().indexOf(e)&&b>e){gotoPageFun(e,c,d);return}if(0>BookInfo.getCurrentPages().indexOf(1)&&1>b){gotoPageFun(1,c,d);return}if(bookConfig.isShowFirstOrLastPagePrompt){b=1>b?getLanguage("lblFirst","This is the first page"):getLanguage("lblLast","This is the last page");global._tipsBox||(_tipsBox=new TipsBox(b,
bookContainer));_tipsBox.setCaption(b);_tipsBox.showTipsBox();return}}d=b;BookInfo.isDoublePage()&&(d=BookInfo.getMaxPageIndex(d));d=Math.max(1,d);if(passwardType()&&bookConfig.excludeFrontPages&&d>=parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()&&(global.passwardPannel||(global.passwardPannel=new PasswardPannel),global.passwardPannel.show(),d>parseInt(bookConfig.excludeFrontPages)))return;switch(bookType){case BookType.normal_book:flipBook.gotoPage(b,c);break;case BookType.single_book:singlePageBook.gotoPage(b,
c);break;case BookType.slide_book:slideBook.gotoPage(b,c);break;case BookType.singleSlide_book:singleSlideBook.gotoPage(b,c);break;case BookType.catalog_book:catalogBook.gotoPage(b,c);break;case BookType.singleCatalog_book:singleCatalogBook.gotoPage(b,c);break;case BookType.documentView_book:singleDocumentViewBook.gotoPage(b,c);break;case BookType.singleDocumentView_book:singleDocumentViewBook.gotoPage(b,c);break;case BookType.card_book:cardBook.gotoPage(b,c)}global.bookmark&&global.bookmark.elements.refreshElements();
bookConfig.SelectTextButtonVisible&&BookInfo.getBook().unSelect();bookConfig.MagnifierButtonVisible&&BookInfo.getBook().unMagnifierZoom();global.annotationPannel&&global.annotationPannel.clearBtnDownCase();global.downLoadBody&&downLoadBody.gotoPage(b);if(bookConfig.AnnotationButtonVisible&&!isPhone()&&!isPad()&&BookInfo.getBook().bookAttachments.noteAdd)BookInfo.getBook().bookAttachments.noteAdd.onResize();
...
function(b,c){var d=window.lastVisitTime?(new Date).getTime()-window.lastVisitTime:0;window.lastVisitTime=(new Date).getTime();0>=b||b>bookConfig.totalPageCount||BookEvent.trigger("flipPage",[c,BookInfo.getCurrentPages().join("-"),BookInfo.getCurrentPagesByIndex(b).join("-"),d])},BookInfo=Class({statics:{getCurrentPages:function(){var b=[];if(this.isDoublePage()){var c=this.getCurrentPageIndex();b=this.getPagesByIndex(c)}else c=this.getCurrentPageIndex(),b.push(c);return b},getCurrentPagesByIndex:function(b){var c=
[];this.isDoublePage()?c=this.getPagesByIndex(b):c.push(b);return c},getPageCount:function(){return bookConfig.totalPageCount},isRightToLeft:function(){return rightToLeft},getBookType:function(){return bookType},getBook:function(){switch(this.getBookType()){case BookType.normal_book:var b=global.flipBook;break;case BookType.single_book:b=global.singlePageBook;break;case BookType.slide_book:b=global.slideBook;break;case BookType.singleSlide_book:b=global.singleSlideBook;break;case BookType.catalog_book:b=
global.catalogBook;break;case BookType.singleCatalog_book:b=global.singleCatalogBook;break;case BookType.documentView_book:b=global.singleDocumentViewBook;break;case BookType.singleDocumentView_book:b=global.singleDocumentViewBook;break;case BookType.card_book:b=global.cardBook}return b},getBooks:function(){var b=[];global.flipBook&&b.push(global.flipBook);global.singlePageBook&&b.push(global.singlePageBook);global.slideBook&&b.push(global.slideBook);global.singleSlideBook&&b.push(global.singleSlideBook);
global.catalogBook&&b.push(global.catalogBook);global.singleCatalogBook&&b.push(global.singleCatalogBook);global.cardBook&&b.push(global.cardBook);return b},getCurrentPageIndex:function(){var b=this.getBook();return b&&b.getCurrentPageIndex?b.getCurrentPageIndex():bookConfig.OriginPageIndex},isDoublePage:function(b){var c=this.getBookType();void 0!=b&&(c=b);switch(c){case BookType.single_book:return!1;case BookType.singleSlide_book:return!1;case BookType.singleCatalog_book:return!1;case BookType.documentView_book:return!1;
case BookType.singleDocumentView_book:return!1;case BookType.card_book:return!1}return!0},left:function(){var b=this.getBook();return b&&b.getLeft?b.getLeft():0},top:function(){var b=this.getBook();return b&&b.getTop?b.getTop():0},width:function(){var b=this.getBook();return b&&b.getWidth?b.getWidth():0},height:function(){var b=this.getBook();return b&&b.getHeight?b.getHeight():0},scale:function(){var b=this.getBook();return b&&b.getScale?b.getScale():0},isZoomming:function(){return bookType===BookType.documentView_book||
bookType===BookType.singleDocumentView_book?this.getBook().docViewBook.parameters.zoomming:this.getBook().showPage.parameters.zoomming},zoomStatus:function(){return this.getBook()&&this.getBook().status_zoom?!0:!1},container:function(){return bookContainer},getThumbnailPages:function(){for(var b=[],c=Math.ceil(bookConfig.totalPageCount/2),d=0;d<=c;d++){var e=this.getPagesByIndex(2*d+1);0<e.length&&b.push(e)}return b},getPagesByIndex:function(b){function c(f){1<=f&&f<=bookConfig.totalPageCount&&d.push(f)}
var d=[];if(bookConfig.isTheBookOpen){b=2*Math.ceil(b/2);var e=b-1}else e=2*Math.floor(b/2),b=e+1;rightToLeft?(c(b),c(e)):(c(e),c(b));return d},isLeftPage:function(b,c){c=void 0==c?this.isDoublePage():c;if(!c&&!rightToLeft)return!1;if(!c&&rightToLeft||(0==b%2&&!rightToLeft||0!=b%2&&rightToLeft)&&!bookConfig.isTheBookOpen)return!0;if((0==b%2&&!rightToLeft||0!=b%2&&rightToLeft)&&bookConfig.isTheBookOpen||(0==b%2&&rightToLeft||0!=b%2&&!rightToLeft)&&!bookConfig.isTheBookOpen)return!1;if((0==b%2&&rightToLeft||
...
this.pageFlipShadow||(this.pageFlipShadow="magazine"==bookConfig.pageHighlightType?new IssuuPageHighlightsFlipShadow(this.side,this.pageIndex):new IssuuPageFlipShadow(this.side,this.pageIndex))},addHardFlipShadow:function(){this.pageFlipShadow||(this.pageFlipShadow=new HardPageFlipShadow(this.side))},clearFlipShadow:function(){this.pageFlipShadow&&this.pageFlipShadow.clear();this.side.removeClass("boxShadow")},resizeFlipShadow:function(b,c){this.pageFlipShadow&&this.pageFlipShadow.resize(b,c)},centerPage:function(){this.isLeft=
...
var IssuuImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var n=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){n.index=b;n.type=d;n.i=l;n.callback=e;n.errorCallback=f;n.pageWidth=g;n.pageHeight=h;n.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));n.imageURL=p;n.imageObject=new ImageObject;n.imageObject.alt(n.index);
...
bookConfig.textSharpening&&(q="-webkit-optimize-contrast",_agent_.browser.firefox&&(q="-moz-crisp-edges"),_agent_.browser.opera&&(q="-o-crisp-edges"),n.$image.css({"image-rendering":q,"-ms-interpolation-mode":"nearest-neighbor"}));B.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&isPC()?this.switchNormalImage(b,c):(isPhone()||isPad())&&this.resize()},
...
c,d,e,f,g,h,k,l){var n=this,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){n.index=b;n.type=d;n.i=l;n.callback=e;n.errorCallback=f;n.pageWidth=g;n.pageHeight=h;n.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&!bookConfig.isEncryptionBook&&(p=p.removeStartFrom("?"));n.imageURL=p;n.$image=$("<img src='"+n.imageURL+"' style='z-index:0;'/>");bookConfig.EnableRecognizeQRcodePressOnMobile&&n.$image.css({"-webkit-touch-callout":"default"});n.$image[0].onload=function(){this.callback&&
...
0;n=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);p=function(u){l++;this.$images.removeElement(u);this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);for(q=0;q<k.length;q++)B=-1<k[q].indexOf(".svg")?new IssuuImageArrayLoadSvg(b,k[q],c,n,p,e,f,g,q):new IssuuImageArrayLoadImage(b,k[q],c,n,p,e,f,g,q),h.$images.push(B.$image),h.loadArray.push(B);v.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&
...
c),pdfLoadStack.push(this.pdfLoadingTask))},destroy:function(){this.pdfLoadingTask&&(window.pdfLoadStack&&pdfLoadStack.pop(this.pdfLoadingTask),this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),IsuuPageBackground=Class({create:function(b,c,d,e,f,g,h){var k=this,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress){if(!b||!c)return q.return();k.type=c;k.pageWidth=e;k.pageHeight=f;return q.yield(getPageDir(b,c,originTotalPageCount),2)}l=q.yieldResult;n=getPageSize(b,
...
l/25)}.bind(this):function(){k=function(p,q){n(p,q,"Sine")}.animation(this,l)}.bind(this);var n=function(p,q,B){if(!b)return!1;var v=b.pageWidth,u=b.pageHeight,w=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(B=w(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(u*u-B*B):u-f*Math.sqrt(v*v-B*B));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){try{var n=1,p=1;n=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);for(c=0;c<b.length;c++){var q=this.pageArray[b[c]];if(q){var B=transformCSS({tran:l?l:{x:0,y:0},scale:{x:n,y:p},origin:g});this.isCoverPage(b[c])&&(q.tran=l?l:{x:0,y:0},q.scale={x:n,y:p},q.rotateY?(q.$page[0].style.removeProperty("transform-origin"),d=void 0,B=transformCSS({scale:{x:n,
y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})):(d=void 0,B=transformCSS({origin:g,scale:{x:n,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})));q.setCSSByStyle(B);if(q.page.pageFlipShadow){var v=h?transformCSS({scale:{x:k.x/n,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});q.page.pageFlipShadow&&q.page.pageFlipShadow.setCSSByStyle(v)}}}return{x:n,y:p}}catch(u){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);
...
c.executeCallback()});global.toolBar&&global.toolBar.btnZoom&&global.toolBar.changeZoomIcon(!1);this.switchLargeImage();this.parent.hideOtherPage();bookConfig.ZoomToolbarVisible&&bookConfig.isZoomControlBarVisible&&!this.controlBar&&(this.controlBar=new ZoomControlBar(tmpContainer),this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+5));this.controlBar&&(this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+5),this.controlBar.setVisible(!0));
